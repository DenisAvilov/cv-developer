...
const ua = {
  ...
  about: {
    ...
    <strong>  фронтенд </strong> розробників на <strong>React JS</strong>.`,
    p2: `У 2017 році почав знайомитись з веб-розробкою,
    у 2018 році створив свой перший додаток на <strong>JavaScript.</strong>`,
...
const en = {
  ...
  about: {
    ...
    <strong> Frontend </strong> development with <strong>React JS</strong>.`,
    p2: `In 2017 he started getting acquainted with web development,
     in 2018 he created his first application on <strong>JavaScript.</strong>`,
    ...
    p4: `I have no commercial experience in <strong>IT</strong> sphere, 
      excluding template placement <strong>WP</strong> on the server for money.
...
const switchLanguage = false
export const language = switchLanguage ? ua : en
